...
function bindInsertButton(){
	...
	document.getElementById('insertSubmit').addEventListener('click', function(event){
		...
		//Add in 
		req.open('GET', "http://52.36.135.10:3000/insert" + "?" + "name=" + payload.name || "Missing Name" + "&reps=" + payload.reps || 0 + "&weight=" + payload.weight || 0 + "&date=" payload.date || null + "&lbs=" + payload.units || 0, true);
